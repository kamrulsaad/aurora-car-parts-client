            ...
            <div className=' mt-2 flex flex-wrap gap-20 items-center justify-center'>
                <div className="card w-96 bg-base-100 shadow-xl">
                    <figure className="px-10 pt-10">
                        {
                            (user.photoURL || image) ?
                                <img src={user?.photoURL || image} alt="Shoes" className="rounded-full" /> :
                ...
                <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-200">
                    <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                        ...
                        <div className="form-control">
                            ...
                            })} placeholder="Location (City/District)" className="input input-bordered" />
                            <label className="label">
                        ...
                        <div className="form-control">
                            ...
                            })} placeholder="LinkedIn Profile Link" className="input input-bordered" />
                            <label className="label">
                        ...
                        <div className="flex justify-center">
                            <div className="w-96">
                                ...
                                })} className="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-base-200 bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-base-200 focus:border-blue-600 focus:outline-none" type="file" id="formFile" name='image' />
                                <label className="label">
                        ...
                        <div className="form-control mt-3">
                            <input type='submit' value='Update Profile' className="btn btn-primary btn-outline" />
                        </div>
                    </form>
                </div>
            </div>
